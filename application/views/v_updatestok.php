            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="col-lg-12">
                        ...
                        echo form_open_multipart('admin/proseseditstok'); 
                        ...
                        <h3 class="title-5 m-b-35">Edit Stok</h3>
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                       ...
                                       <form class="form-horizontal" method="POST" action="<?php echo base_url(). 'admin/proseseditstok'; ?>" enctype="multipart/form-data" >
