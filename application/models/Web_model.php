...
class Web_Model extends CI_Model {
    ...
    public function get_all_new_product() {
        ...
        $this->db->join('tbl_kategori', 'tbl_kategori.nama_kategori=tbl_produk.nama_kategori');
        $this->db->order_by('tbl_produk.kode_produk', 'DESC');
    ...
    public function get_product_by_id($kode_produk) {
        ...
        $this->db->from('tbl_produk');
        $this->db->order_by('tbl_produk.kode_produk', 'DESC');
        $this->db->where('tbl_produk.kode_produk', $kode_produk);
        $info = $this->db->get();
        return $info->row();
    }
